...
‎[U+200E]1. Open a command prompt as an administrator and enter "ipconfig"
‎[U+200E]2. Find "Ethernet adapter vEthernet (WSL)" and copy the listed IPv4 address.
‎[U+200E]3. In the WSL terminal, navigate to the PX4-Autopilot/ directory.
‎[U+200E]4. Create a new file called run.sh and open it with your text editor of choice.
‎[U+200E]5. Edit the contents to say
```
#!/bin/sh
export PX4_HOME_LAT=
export PX4_HOME_LON=
...
make px4_sitl_default
```
‎[U+200E]6. Set the PX4_SIM_HOST_ADDR to the copied IP, and the lat and lon to the local coordinates of your test site.
‎[U+200E]7. In WSL, type "sh ./run.sh" to launch the SITL program.
